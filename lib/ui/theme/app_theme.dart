...
class AppTextStyles {
  AppTextStyles._();
  static const screenTitle  = TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: AppColors.grayDark);
  static const screenSub    = TextStyle(fontSize: 13, color: AppColors.grayMid);
  static const sectionLabel = TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: AppColors.grayMid, letterSpacing: 0.5);
  static const medName      = TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.grayDark);
  static const medDetail    = TextStyle(fontSize: 12, color: AppColors.grayMid);
  static const metricValue  = TextStyle(fontSize: 24, fontWeight: FontWeight.w700);
